...
import "github.com/nxenv/rapidship/nxenv-migrate/internal/types/enum"
...
const (
	...
	DefaultSecretManager = "nxenvSecretManager"
)
...
type (
	...
	SecretText struct {
		...
		Manager string  `json:"secretManagerIdentifier"` // nxenvSecretManager
	}
)
...
type (
	...
	projectEnvelope struct {
		...
		Data   *struct {
			...
			Nxenvmanaged bool     `json:"nxenvManaged"`
		} `json:"data"`
	}
