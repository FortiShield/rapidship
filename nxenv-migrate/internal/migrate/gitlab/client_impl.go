...
import (
	...
	"github.com/nxenv/rapidship/nxenv-migrate/internal/checkpoint"
	"github.com/nxenv/rapidship/nxenv-migrate/internal/common"
	"github.com/nxenv/rapidship/nxenv-migrate/internal/gitexporter"
	"github.com/nxenv/rapidship/nxenv-migrate/internal/nxenv"
	"github.com/nxenv/rapidship/nxenv-migrate/internal/report"
	"github.com/nxenv/rapidship/nxenv-migrate/internal/tracer"
	"github.com/nxenv/rapidship/nxenv-migrate/internal/types"
	externalTypes "github.com/nxenv/rapidship/nxenv-migrate/types"
...
func (e *Export) GetUserByUserName(
	...
	if len(out) == 0 {
		return nil, res, fmt.Errorf("user response is empty: %w", nxenv.ErrNotFound)
	}
...
func (e *Export) GetUserByID(
	...
	if res.Status == 404 {
		return nil, res, fmt.Errorf("user not found: %w", nxenv.ErrNotFound)
	}
