...
When they are exported, supported Github branch protection rules and webhooks are stored in zip file, which later during import to nxenv code are mapped according to:

### Webhooks
| Github events | Nxenv Code events
|---|---|
...
| Github rule(set) | Nxenv Code rule
|---|---|
