...
import (
	...
	"github.com/nxenv/rapidship/nxenv-migrate/internal/migrate"
...
func CreateImporter(nxenvAccount, nxenvOrg, nxenvToken, githubToken, gitlabToken, bitbucketToken, nxenvAddress string) *migrate.Importer {
	importer := &migrate.Importer{
		Nxenv:    nxenv.New(nxenvAccount, nxenvToken, nxenv.WithAddress(nxenvAddress)),
		NxenvOrg: nxenvOrg,
	}
	switch {
	case githubToken != "":
