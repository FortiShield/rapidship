...
When they are exported, supported Stash branch protection rules and webhooks are stored in zip file, which later during import to nxenv code are mapped according to:

### Webhooks
| Bitbucket Server events | Nxenv Code events
|---|---|
...
| Bitbucket Server rule | Nxenv Code rule
|---|---|
