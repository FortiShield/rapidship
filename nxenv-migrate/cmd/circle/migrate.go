...
import (
	...
	"github.com/nxenv/rapidship/nxenv-migrate/internal/migrate/circle"
	"github.com/nxenv/rapidship/nxenv-migrate/internal/migrate/circle/client"
...
func registerMigrate(app *kingpin.CmdClause) {
	...
	cmd := app.Command("migrate", "migrate circle data to nxenv").
		Hidden().
		Action(c.run)
