...
When they are exported, supported Bitbucket branch protection rules and webhooks are stored in zip file, which later during import to nxenv code are mapped according to:

### Webhooks
| Bitbucket events | Nxenv Code events
|---|---|
...
| Bitbucket rule(set) | Nxenv Code rule
|---|---|
