...
import (
	...
	"github.com/nxenv/rapidship/app/pipeline/logger"
	"github.com/nxenv/rapidship/profiler"
...
func SetupProfiler(config *types.Config) {
	...
	rapidshipProfiler, _ := profiler.New(profilerType)
	rapidshipProfiler.StartProfiling(config.Profiler.ServiceName, version.Version.String())
}
