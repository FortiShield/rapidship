...
import (
	...
	events "github.com/nxenv/rapidship/app/events/gitspaceinfra"
...
// Provision assumes a docker engine is already running on the Nxenv host machine and re-uses that as infra.
