		...
		Steps: &[]artifact.ClientSetupStep{
			{
				...
				Commands: &[]artifact.ClientSetupStepCommand{
					{
						//nolint:lll
						Value: stringPtr("resolver += “Nxenv Registry” at “<REGISTRY_URL>/<REGISTRY_NAME>”\ncredentials += Credentials(Path.userHome / “.sbt” / “.Credentials”)"),
					},
				},
			},
			{
				...
				Commands: &[]artifact.ClientSetupStepCommand{
					{
						//nolint:lll
						Value: stringPtr("realm=Nxenv Registry\nhost=<LOGIN_HOSTNAME>\nuser=<USERNAME>\npassword={{identity-token}}"),
					},
				},
			},
			{
		...
		Steps: &[]artifact.ClientSetupStep{
			{
				...
				Commands: &[]artifact.ClientSetupStepCommand{
					{
						Value: stringPtr("publishTo := Some(\"Nxenv Registry\" at \"<REGISTRY_URL>/<REGISTRY_NAME>\")"),
					},
				},
			},
			{
