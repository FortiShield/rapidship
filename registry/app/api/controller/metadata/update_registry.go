...
import (
	...
	types2 "github.com/nxenv/rapidship/types"
	rapidshipenum "github.com/nxenv/rapidship/types/enum"
...
func (c *APIController) ModifyRegistry(
	...
	permissionChecks := GetPermissionChecks(space, regInfo.RegistryIdentifier, rapidshipenum.PermissionRegistryEdit)
