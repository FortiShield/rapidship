...
// ArtifactStats Nxenv Artifact Stats
...
// ArtifactSummary Nxenv Artifact Summary
...
// CleanupPolicy Cleanup Policy for Nxenv Artifact Registries
...
// DockerLayerEntry Nxenv Artifact Layers
type DockerLayerEntry struct {
	Command string  `json:"command"`
	Size    *string `json:"size,omitempty"`
}

// DockerLayersSummary Nxenv Layers Summary
...
// DockerManifestDetails Nxenv Artifact Layers
...
// DockerManifests Nxenv Manifests
...
// ListArtifactLabel A list of Nxenv Artifact Labels
...
// ListRegistry A list of Nxenv Artifact Registries
type ListRegistry struct {
	...
	// Registries A list of Nxenv Artifact Registries
...
// ListWebhooks A list of Nxenv Registries webhooks
...
// ListWebhooksExecutions A list of Nxenv Registries webhooks executions
...
// Registry Nxenv Artifact Registry
...
// RegistryMetadata Nxenv Artifact Registry Metadata
...
// UpstreamConfig Configuration for Nxenv Artifact UpstreamProxies
...
// VirtualConfig Configuration for Nxenv Virtual Artifact Registries
type VirtualConfig struct {
	UpstreamProxies *[]string `json:"upstreamProxies,omitempty"`
}

// Webhook Nxenv Regstries Webhook
type Webhook struct {
	CreatedAt    *string        `json:"createdAt,omitempty"`
...
// WebhookExecRequest Nxenv Regstries HTTP Webhook Request
...
// WebhookExecResponse Nxenv Regstries HTTP Webhook Response
...
// WebhookExecution Nxenv Regstries Webhook Execution
type WebhookExecution struct {
	...
	// Request Nxenv Regstries HTTP Webhook Request
	Request *WebhookExecRequest `json:"request,omitempty"`

	// Response Nxenv Regstries HTTP Webhook Response
...
type FileDetailResponse struct {
	// Files A list of Nxenv Artifact Files
...
type ListArtifactLabelResponse struct {
	// Data A list of Nxenv Artifact Labels
...
type ListRegistryResponse struct {
	// Data A list of Nxenv Artifact Registries
...
type ListWebhooksExecutionResponse struct {
	// Data A list of Nxenv Registries webhooks executions
...
type ListWebhooksResponse struct {
	// Data A list of Nxenv Registries webhooks
...
type WebhookExecutionResponse struct {
	// Data Nxenv Regstries Webhook Execution
