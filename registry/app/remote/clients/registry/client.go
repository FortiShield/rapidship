...
import (
	...
	commonhttp "github.com/nxenv/rapidship/registry/app/common/http"
	"github.com/nxenv/rapidship/registry/app/common/lib"
	"github.com/nxenv/rapidship/registry/app/common/lib/errors"
	"github.com/nxenv/rapidship/registry/app/manifest"
	"github.com/nxenv/rapidship/registry/app/manifest/manifestlist"
	"github.com/nxenv/rapidship/registry/app/manifest/schema2"
	"github.com/nxenv/rapidship/registry/app/pkg/commons"
	"github.com/nxenv/rapidship/registry/app/pkg/maven/utils"
	"github.com/nxenv/rapidship/registry/app/remote/clients/registry/auth"
	"github.com/nxenv/rapidship/registry/app/remote/clients/registry/interceptor"

	"github.com/opencontainers/go-digest"
	v1 "github.com/opencontainers/image-spec/specs-go/v1"
	"github.com/rs/zerolog/log"

	_ "github.com/nxenv/rapidship/registry/app/manifest/ocischema" // register oci manifest unmarshal function
)
...
// const definition.
const (
	UserAgent = "rapidship-registry-client"
...
func init() {
	...
	if env := os.Getenv("RAPIDSIP_REGISTRY_HTTP_CLIENT_TIMEOUT"); len(env) > 0 {
		...
		if err != nil {
			log.Error().
				...
				Msg(
					fmt.Sprintf(
						"Failed to parse RAPIDSIP_REGISTRY_HTTP_CLIENT_TIMEOUT: %v, use default value: %v",
