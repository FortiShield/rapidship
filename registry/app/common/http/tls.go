...
const (
	// Internal TLS ENV.
	internalTLSEnable        = "RAPIDSIP_INTERNAL_TLS_ENABLED"
	internalVerifyClientCert = "RAPIDSIP_INTERNAL_VERIFY_CLIENT_CERT"
	internalTLSKeyPath       = "RAPIDSIP_INTERNAL_TLS_KEY_PATH"
	internalTLSCertPath      = "RAPIDSIP_INTERNAL_TLS_CERT_PATH"
)
