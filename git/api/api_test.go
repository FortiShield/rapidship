...
func TestParseSignatureFromCatFileLine(t *testing.T) {
	...
	testParseSignatureFromCatFileLineFor(t, "Max", "max@rapidship.io", "1666050206 +0530", 1666050206, 5*60*60+30*60)
	testParseSignatureFromCatFileLineFor(t, "Max", "max@rapidship.io", "1666401234 +0000", 1666401234, 0)
