...
import (
	...
	"github.com/nxenv/rapidship/git/command"
	"github.com/nxenv/rapidship/git/enum"
...
// Will match "31\t0\t.nxenv/apidiff.yaml" and extract 31, 0 and .nxenv/apidiff.yaml.
// Will match "-\t-\ttools/code-api/chart/charts/nxenv-common-1.0.27.tgz" and extract -, -, and a filename.
