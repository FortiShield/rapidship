...
const (
	EnvActorName  = "RAPIDSIP_HOOK_ACTOR_NAME"
	EnvActorEmail = "RAPIDSIP_HOOK_ACTOR_EMAIL" //#nosec
	EnvRepoUID    = "RAPIDSIP_HOOK_REPO_UID"
	EnvRequestID  = "RAPIDSIP_HOOK_REQUEST_ID"
)
