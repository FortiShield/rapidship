...
import (
	...
	"github.com/nxenv/rapidship/store"
	"github.com/nxenv/rapidship/types"

	"github.com/rs/zerolog/log"
)

// systemServicePrincipal is the principal representing Nxenv.
// It is used for all operations executed by Nxenv itself.
...
// pipeline executions for calling Nxenv APIs.
...
// gitspace token injection for calling Nxenv APIs.
...
// SystemService sets up the Nxenv service principal that is used for
...
// gitspace credential injection for calling Nxenv APIs.
