...
func (s *RapidshipSCM) ListBranches(
	ctx context.Context,
	filter *BranchFilter,
...
func (s *RapidshipSCM) ListRepositories(
	ctx context.Context,
...
func (s *RapidshipSCM) ResolveCredentials(
	ctx context.Context,
	...
	userInfo := url.UserPassword("nxenv", jwtToken)
...
func (s *RapidshipSCM) GetFileContent(
	ctx context.Context,
	gitspaceConfig types.GitspaceConfig,
	filePath string,
	_ *ResolvedCredentials,
...
func (s *RapidshipSCM) GetBranchURL(_ string, repoURL string, branch string) (string, error) {
