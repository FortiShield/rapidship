...
import (
	...
	capabilitiesctrl "github.com/nxenv/rapidship/app/api/controller/capabilities"
	"github.com/nxenv/rapidship/app/auth/authz"
	"github.com/nxenv/rapidship/app/services/capabilities"
	aitypes "github.com/nxenv/rapidship/types/aigenerate"
)

var _ Intelligence = RapidshipIntelligence{}
...
type RapidshipIntelligence struct {
...
func (h RapidshipIntelligence) UpdatePipeline(
	_ context.Context,
...
func (h RapidshipIntelligence) UpdatePipelineStage(
	_ context.Context,
...
func (h RapidshipIntelligence) UpdatePipelineStep(
	_ context.Context,
...
func (h RapidshipIntelligence) GeneratePipeline(
	_ context.Context,
...
func (h RapidshipIntelligence) GeneratePipelineStage(
	_ context.Context,
...
func (h RapidshipIntelligence) GeneratePipelineStep(
	_ context.Context,
