...
func TestService_ParseCodeOwner(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{`**/contracts/openapi/v1/ user1@nxenv.io user2@nxenv.io`},
			want: []Entry{
				{
					LineNumber: 1,
					Pattern:    "**/contracts/openapi/v1/",
					Owners:     []string{"user1@nxenv.io", "user2@nxenv.io"},
				},
			},
		},
		{
			...
			args: args{`
**/contracts/openapi/v1/ user1@nxenv.io user2@nxenv.io
/scripts/api user3@nxenv.io user4@nxenv.io
			`},
			want: []Entry{
				{
					LineNumber: 2,
				...
				},
				{
					LineNumber: 3,
					Pattern:    "/scripts/api",
					Owners:     []string{"user3@nxenv.io", "user4@nxenv.io"},
				},
			},
		},
		{
...
**/contracts/openapi/v1/ user1@nxenv.io user2@nxenv.io
#
/scripts/api user1@nxenv.io user2@nxenv.io
			`},
			want: []Entry{
				{
					LineNumber: 3,
...
\\\ \*\\\\\? user4@nxenv.io
			...
			want: []Entry{
				...
				},
				{
					...
					LineNumber: 5,
					Pattern:    " 	#",
					Owners:     []string{"user2@nxenv.io"},
				},
				{
					LineNumber: 7,
					Pattern:    "\\*\\?\\[\\]\\{\\}\\-\\!\\^",
					Owners:     []string{"user3@nxenv.io"},
				},
				{
					LineNumber: 9,
					Pattern:    "\\\\ \\*\\\\\\\\\\?",
					Owners:     []string{"user4@nxenv.io"},
				},
			},
		},
		{
...
D∆NCE user@h∆rness.io
		...
		},
		{
			...
			args: args{`
a\		user1@nxenv.io	user2@nxenv.io  	 user3@nxenv.io
			...
			want: []Entry{
				{
					LineNumber: 2,
					Pattern:    "a	",
					Owners:     []string{"user1@nxenv.io", "user2@nxenv.io", "user3@nxenv.io"},
				},
			},
		},
		{
...
d#
e# user1@nxenv.io
f user1@nxenv.io#user2@nxenv.io
g   user1@nxenv.io	#  user2@nxenv.io
			`},
			want: []Entry{
				{
					LineNumber: 2,
