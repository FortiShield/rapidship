...
import (
	...
	"github.com/nxenv/rapidship/app/api/controller/check"
	"github.com/nxenv/rapidship/app/api/controller/connector"
	"github.com/nxenv/rapidship/app/api/controller/execution"
	controllergithook "github.com/nxenv/rapidship/app/api/controller/githook"
	"github.com/nxenv/rapidship/app/api/controller/gitspace"
	"github.com/nxenv/rapidship/app/api/controller/infraprovider"
	"github.com/nxenv/rapidship/app/api/controller/keywordsearch"
	"github.com/nxenv/rapidship/app/api/controller/logs"
	...
	"github.com/nxenv/rapidship/app/api/controller/trigger"
	...
	"github.com/nxenv/rapidship/app/api/controller/webhook"
	"github.com/nxenv/rapidship/app/api/handler/account"
	handleraiagent "github.com/nxenv/rapidship/app/api/handler/aiagent"
	handlercapabilities "github.com/nxenv/rapidship/app/api/handler/capabilities"
	handlercheck "github.com/nxenv/rapidship/app/api/handler/check"
	handlerconnector "github.com/nxenv/rapidship/app/api/handler/connector"
	handlerexecution "github.com/nxenv/rapidship/app/api/handler/execution"
	handlergithook "github.com/nxenv/rapidship/app/api/handler/githook"
	handlergitspace "github.com/nxenv/rapidship/app/api/handler/gitspace"
	handlerinfraProvider "github.com/nxenv/rapidship/app/api/handler/infraprovider"
	handlerkeywordsearch "github.com/nxenv/rapidship/app/api/handler/keywordsearch"
	handlerlogs "github.com/nxenv/rapidship/app/api/handler/logs"
	handlermigrate "github.com/nxenv/rapidship/app/api/handler/migrate"
	handlerpipeline "github.com/nxenv/rapidship/app/api/handler/pipeline"
	handlerplugin "github.com/nxenv/rapidship/app/api/handler/plugin"
	handlerprincipal "github.com/nxenv/rapidship/app/api/handler/principal"
	handlerpullreq "github.com/nxenv/rapidship/app/api/handler/pullreq"
	handlerrepo "github.com/nxenv/rapidship/app/api/handler/repo"
	handlerreposettings "github.com/nxenv/rapidship/app/api/handler/reposettings"
	"github.com/nxenv/rapidship/app/api/handler/resource"
	handlersecret "github.com/nxenv/rapidship/app/api/handler/secret"
	handlerserviceaccount "github.com/nxenv/rapidship/app/api/handler/serviceaccount"
	handlerspace "github.com/nxenv/rapidship/app/api/handler/space"
	handlersystem "github.com/nxenv/rapidship/app/api/handler/system"
	handlertemplate "github.com/nxenv/rapidship/app/api/handler/template"
	handlertrigger "github.com/nxenv/rapidship/app/api/handler/trigger"
	handlerupload "github.com/nxenv/rapidship/app/api/handler/upload"
	handleruser "github.com/nxenv/rapidship/app/api/handler/user"
	handlerUserGroup "github.com/nxenv/rapidship/app/api/handler/usergroup"
	"github.com/nxenv/rapidship/app/api/handler/users"
	handlerwebhook "github.com/nxenv/rapidship/app/api/handler/webhook"
	"github.com/nxenv/rapidship/app/api/middleware/address"
	middlewareauthn "github.com/nxenv/rapidship/app/api/middleware/authn"
	"github.com/nxenv/rapidship/app/api/middleware/encode"
	"github.com/nxenv/rapidship/app/api/middleware/logging"
	"github.com/nxenv/rapidship/app/api/middleware/nocache"
	middlewareprincipal "github.com/nxenv/rapidship/app/api/middleware/principal"
	"github.com/nxenv/rapidship/app/api/request"
	"github.com/nxenv/rapidship/app/auth/authn"
	"github.com/nxenv/rapidship/app/githook"
...
func setupAiAgent(r chi.Router, aiagentCtrl *aiagent.Controller, capabilitiesCtrl *capabilities.Controller) {
	r.Route("/nxenv-intelligence", func(r chi.Router) {
