...
type Provider interface {
	...
	// interact with Nxenv and clone a repo.
...
// Provider provides the URLs of the Nxenv system.
type provider struct {
	...
	// containerURL stores the URL that can be used to communicate with Nxenv from inside a
	// build container.
