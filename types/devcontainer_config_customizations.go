...
const (
	GitspaceCustomizationsKey  CustomizationsKey = "nxenvGitspaces"
...
// GitspaceCustomizationSpecs contains details about nxenv platform connectors.
// eg:
//
//	"customizations": {
//	  "nxenvGitspaces": {
