...
import { Text } from '@nxenvio/uicore'
import { IconName, NxenvIcons } from '@nxenvio/icons'
import type { Spacing, PaddingProps } from '@nxenvio/design-system'
...
export const TabTitleWithCount: React.FC<{
  ...
  const TabIcon: React.ElementType = NxenvIcons[icon]
