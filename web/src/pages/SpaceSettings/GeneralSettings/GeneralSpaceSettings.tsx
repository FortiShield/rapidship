...
import { Intent, Color, FontVariation } from '@nxenvio/design-system'
...
import Nxenv from '../../../icons/Nxenv.svg?url'
        ...
        <Layout.Vertical
          ...
          <Heading level={3} font={{ variation: FontVariation.H3 }} margin={{ bottom: 'large' }}>
            <Layout.Horizontal className={css.upgradeHeader}>
              <img width={30} height={30} src={Nxenv} />
              <Text padding={{ left: 'small' }} font={{ variation: FontVariation.H4 }}>
                {step === 0 && <>{getString('exportSpace.upgradeNxenv')}</>}
                ...
                <Layout.Vertical padding={{ top: 'medium' }}>
                  {upgrading ? (
                    <Container
                      ...
                      <img width={148} height={148} src={Nxenv} className={css.nxenvUpgradeWatermark} />
                      <Layout.Horizontal className={css.upgradeContainer}>
                        <img width={24} height={24} src={Nxenv} color={'blue'} />
                            ...
                            {exportDone ? (
                              <Text
                                ...
                                <Text padding={{ left: 'small' }}>
                                  ...
                                  {!repoCount && (
                                    <a target="_blank" rel="noreferrer" href="https://docs.rapidship.com/support">
                    ...
                    <Container
                      ...
                      margin={{ bottom: 'medium' }}
                      className={css.generalContainer}>
                      <img width={148} height={148} src={Nxenv} className={css.nxenvWatermark} />
                      <Layout.Horizontal className={css.upgradeContainer}>
                        <img width={24} height={24} src={Nxenv} color={'blue'} />
                      ...
                      <Text padding={{ top: 'large', left: 'xlarge' }} color={Color.GREY_500} font={{ size: 'small' }}>
                        ...
                        <a target="_blank" rel="noreferrer" href="https://developer.nxenv.io/docs/code-repository">
                          <Icon className={css.icon} name="code-info" size={16} />
                        </a>
                      </Text>
                    </Container>
