...
const useLabelModal = ({ refetchlabelsList }: LabelModalProps) => {
  ...
  //ToDo : Remove getLabelValuesPromiseQuery component when Encoding is handled by BE for Nxenv
  ...
  //ToDo: Remove all references of suffix with Query when Encoding is handled by BE for Nxenv
