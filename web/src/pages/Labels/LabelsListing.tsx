    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row }: CellProps<LabelTypes>) => {
          ...
          //ToDo : Remove the following block when Encoding is handled by BE for Nxenv
          const deleteLabelPathNxenv =
            row.original?.scope === 0
          ...
          //ToDo: remove type check of standalone when Encoding is handled by BE for Nxenv
