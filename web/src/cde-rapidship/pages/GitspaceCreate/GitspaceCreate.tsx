...
import { Breadcrumbs, Card, Container, Heading, Layout, Page, Text } from '@nxenvio/uicore'
import { Color } from '@nxenvio/design-system'
import { useStrings } from 'framework/strings'
import { useGetSpaceParam } from 'hooks/useGetSpaceParam'
import { useAppContext } from 'AppContext'
import { RapidshipCreateGitspace } from './RapidshipCreateGitspace'
      ...
      <Page.Body className={css.main}>
        ...
        <Card className={css.cardMain}>
          <Container className={css.subContainers}>
            {standalone ? <RapidshipCreateGitspace /> : <CDECreateGitspace />}
          </Container>
        </Card>
      </Page.Body>
    </>
