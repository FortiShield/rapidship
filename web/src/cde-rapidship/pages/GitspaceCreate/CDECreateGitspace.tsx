...
import { getRepoIdFromURL, getRepoNameFromURL } from 'cde-rapidship/utils/SelectRepository.utils'
import { useGetSpaceParam } from 'hooks/useGetSpaceParam'
import { useStrings } from 'framework/strings'
import { useAppContext } from 'AppContext'
import { getErrorMessage } from 'utils/Utils'
import { GitspaceSelect } from 'cde-rapidship/components/GitspaceSelect/GitspaceSelect'
import nxenvCode from 'cde-rapidship/assests/nxenvCode.svg?url'
import genericGit from 'cde-rapidship/assests/genericGit.svg?url'
import rapidshipIcon from 'cde-rapidship/assests/rapidship.svg?url'
import github from 'cde-rapidship/assests/github.svg?url'
import gitlab from 'cde-rapidship/assests/gitlab.svg?url'
import bitbucket from 'cde-rapidship/assests/bitbucket.svg?url'
import { CDEAnyGitImport } from 'cde-rapidship/components/CDEAnyGitImport/CDEAnyGitImport'
import { CDEIDESelect } from 'cde-rapidship/components/CDEIDESelect/CDEIDESelect'
import { SelectInfraProvider } from 'cde-rapidship/components/SelectInfraProvider/SelectInfraProvider'
...
import { EnumGitspaceCodeRepoType, getIDEOption } from 'cde-rapidship/constants'
import { CDESSHSelect } from 'cde-rapidship/components/CDESSHSelect/CDESSHSelect'
import { useQueryParams } from 'hooks/useQueryParams'
import { CDEUnknownSCM } from 'cde-rapidship/components/CDEAnyGitImport/CDEUnknownSCM'
...
export const scmOptions: SCMType[] = [
  { name: 'Nxenv Code', value: EnumGitspaceCodeRepoType.NXENV_CODE, icon: nxenvCode },
  ...
  { name: 'Rapidship', value: EnumGitspaceCodeRepoType.RAPIDSIP, icon: rapidshipIcon }
]
...
export const CDECreateGitspace = () => {
  ...
  return (
    <Formik
      ...
      initialValues={{
        ...rapidshipFormInitialValues,
        code_repo_type: EnumGitspaceCodeRepoType.NXENV_CODE,
        ...includeQueryParams,
        metadata: { infraProvider: 'NXENV_GCP' }
      }}
      validationSchema={validateRapidshipForm(getString, true)}
            ...
            <FormikForm>
              <Container className={css.formContainer}>
                <Container>
                  ...
                  />
                  {![
                    EnumGitspaceCodeRepoType.NXENV_CODE,
