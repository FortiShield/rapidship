...
import noSpace from 'cde-rapidship/assests/no-gitspace.svg?url'
import { useUpdateQueryParams } from 'hooks/useUpdateQueryParams'
import { useQueryParams } from 'hooks/useQueryParams'
import { ListGitspaces } from 'cde-rapidship/components/GitspaceListing/ListGitspaces'
import CDEHomePage from 'cde-rapidship/components/CDEHomePage/CDEHomePage'
import UsageMetrics from 'cde-rapidship/components/UsageMetrics/UsageMetrics'

import StatusDropdown from 'cde-rapidship/components/StatusDropdown/StatusDropdown'
import GitspaceOwnerDropdown from 'cde-rapidship/components/GitspaceOwnerDropdown/GitspaceOwnerDropdown'
import { docLink, GitspaceOwnerType, GitspaceStatus, SortByType } from 'cde-rapidship/constants'

import SortByDropdown from 'cde-rapidship/components/SortByDropdown/SortByDropdown'
...
import zeroDayCss from 'cde-rapidship/components/CDEHomePage/CDEHomePage.module.scss'
            ...
            title={
              <Layout.Vertical spacing="none">
                <div className="ng-tooltip-native">
                  ...
                  <NxenvDocTooltip tooltipId="GitSpaceListPageHeading" useStandAlone={true} />
                </div>
                {!standalone ? (
                  <Text
                    font="small"
