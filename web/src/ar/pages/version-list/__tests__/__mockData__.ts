...
import type { DockerManifests, ListArtifactVersion } from '@nxenvio/react-har-service-client'
  ...
  artifactVersions: [
    {
      ...
      name: '1.0.15',
      packageType: 'HELM',
      pullCommand: 'helm pull oci://pkg.qa.nxenv.io/iwnq/helm-repo-1/nxenv-delegate-ng:1.0.15',
      registryIdentifier: '',
      registryPath: '',
      size: '8.63KB',
      downloadsCount: 0
  ...
  artifactVersions: [
    {
      ...
      name: '1.0.15',
      packageType: 'HELM',
      pullCommand: 'helm pull oci://pkg.qa.nxenv.io/iwft7r-f_zp7q/helm-repo-1/nxenv-delegate-ng:1.0.15',
      registryIdentifier: '',
      registryPath: '',
      size: '8.63KB',
      downloadsCount: 0
  ...
  artifactVersions: [
    {
      ...
      name: '1.0.0',
      packageType: 'DOCKER',
      pullCommand: 'docker pull pkg.qa.nxenv.io/iwnhltqp7q/docker-repo/podinfo-artifact:1.0.0',
      registryIdentifier: '',
      registryPath: '',
      size: '69.56MB'
    }
  ...
  artifactVersions: [
    {
      ...
      name: '1.0.0',
      packageType: 'DOCKER',
      pullCommand: 'docker pull pkg.qa.nxenv.io/iwnhltzp7q/docker-repo/podinfo-artifact:1.0.0',
      registryIdentifier: '',
      registryPath: '',
      size: '69.56MB'
    }
