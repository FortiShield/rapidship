...
import { ExpandingSearchInput, NxenvDocTooltip, Page, Button, ButtonVariation } from '@nxenvio/uicore'
import type { ExpandingSearchInputHandle } from '@nxenvio/uicore'
import { useGetAllRegistriesQuery } from '@nxenvio/react-har-service-client'
      ...
      <Page.Header
        ...
        title={
          <div className="ng-tooltip-native">
            ...
            <NxenvDocTooltip tooltipId="artifactRepositoriesPageHeading" useStandAlone={true} />
          </div>
        }
