...
export const MockGetHelmRegistryResponseWithAllData = {
  content: {
    data: {
      ...
      packageType: 'HELM',
      url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/helm-repo',
      ...
      sections: [
        {
          ...
          steps: [
            {
              commands: ['helm registry login pkg.qa.nxenv.io'],
        ...
        },
        {
          ...
          steps: [
            {
              commands: [
                'helm push \u003cCHART_TGZ_FILE\u003e oci://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/helm-create-test'
              ],
              header:
        ...
        },
        {
          ...
          steps: [
            {
              commands: [
                'helm pull oci://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/helm-create-test/\u003cIMAGE_NAME\u003e --version \u003cTAG\u003e'
              ],
