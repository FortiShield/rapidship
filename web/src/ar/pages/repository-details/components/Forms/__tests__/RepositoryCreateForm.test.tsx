...
import { useToaster } from '@nxenvio/uicore'
import userEvent from '@testing-library/user-event'
import { fireEvent, render, waitFor } from '@testing-library/react'
import { useCreateRegistryMutation } from '@nxenvio/react-har-service-client'
...
jest.mock('@nxenvio/uicore', () => ({
  ...jest.requireActual('@nxenvio/uicore'),
