...
export const MockGetDockerRegistryResponseWithMinimumData = {
  content: {
    data: {
      ...
      packageType: 'DOCKER',
      url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/docker-repo',
      cleanupPolicy: []
    },
    status: 'SUCCESS'
  }
      ...
      registries: [
        {
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/docker-proxy'
        },
        {
          description: '',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/docker-proxy-2'
        },
        {
          description: '',
          identifier: 'proxy-1',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/proxy-1'
        },
        {
          description: '',
          identifier: 'proxy-3',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/proxy-3'
        },
        {
          description: '',
          identifier: 'proxy-4',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/proxy-4'
        },
        {
          description: '',
          identifier: 'proxy-5',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/proxy-5'
        },
        {
          description: '',
          identifier: 'proxy-6',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/proxy-6'
        },
        {
          description: '',
          identifier: 'proxy-10',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/proxy-10'
        },
        {
          description: '',
          ...
          registrySize: '0.00B',
          type: 'UPSTREAM',
          url: 'https://pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/docker-hub-proxy'
        }
      ]
    },
    status: 'SUCCESS'
