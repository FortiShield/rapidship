...
import type { GetAllArtifactsByRegistryOkResponse } from '@nxenvio/react-har-service-client'
      ...
      sections: [
        {
          ...
          steps: [
            {
              commands: [
                'docker login pkg.qa.nxenv.io',
                'Username: shivanand.sonnad@nxenv.io',
                'Password: *see step 2*'
              ],
        ...
        },
        {
          ...
          steps: [
            {
              commands: [
                'docker tag \u003cIMAGE_NAME\u003e:\u003cTAG\u003e pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/docker-repo/\u003cIMAGE_NAME\u003e:\u003cTAG\u003e'
              ],
            ...
            {
              commands: [
                'docker push pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/docker-repo/\u003cIMAGE_NAME\u003e:\u003cTAG\u003e'
              ],
        ...
        },
        {
          ...
          steps: [
            {
              commands: [
                'docker pull pkg.qa.nxenv.io/iwnhltqot7gft7r-f_zp7q/docker-repo/\u003cIMAGE_NAME\u003e:\u003cTAG\u003e'
              ],
