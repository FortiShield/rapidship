...
import { TableV2, type PaginationProps } from '@nxenvio/uicore'
import type { ArtifactDeploymentsDetail, ArtifactDeploymentsDetails } from '@nxenvio/react-har-service-client'
