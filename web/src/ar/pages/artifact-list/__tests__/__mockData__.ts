...
import type { GetAllRegistriesOkResponse } from '@nxenvio/react-har-service-client'

export const mockEmptyUseGetAllNxenvArtifactsQueryResponse = {
  isFetching: false,
  data: {
    content: {
      data: {
...
export const mockErrorUseGetAllNxenvArtifactsQueryResponse = {
  isFetching: false,
  data: null,
  refetch: jest.fn(),
  error: {
...
export const mockUseGetAllNxenvArtifactsQueryResponse = {
  isFetching: false,
  data: {
    content: {
      data: {
        artifacts: [
          {
            ...
            packageType: 'DOCKER',
            pullCommand: 'docker pull pkg.qa.nxenv.io/iwr-f_zp7q/repo1/podinfo-artifact:1.0.0',
          ...
          },
          {
            ...
            name: 'production',
            packageType: 'HELM',
            pullCommand: 'helm install pkg.qa.nxenv.io/iwr-f_zp7q/repo2/production:1.0.15',
          ...
          },
          {
            ...
            latestVersion: '',
            name: 'nxenv-delegate-ng',
            packageType: 'HELM',
            pullCommand: 'helm install pkg.qa.nxenv.io/iwr-f_zp7q/upstream_1/nxenv-delegate-ng:1.0.15',
