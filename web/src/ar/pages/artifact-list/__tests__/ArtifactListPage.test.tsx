...
import {
  useGetAllNxenvArtifactsQuery as _useGetAllNxenvArtifactsQuery,
...
import {
  ...
  mockEmptyUseGetAllNxenvArtifactsQueryResponse,
  mockUseGetAllNxenvArtifactsQueryResponse,
  mockErrorUseGetAllNxenvArtifactsQueryResponse
} from './__mockData__'

const useGetAllNxenvArtifactsQuery = _useGetAllNxenvArtifactsQuery as jest.Mock
const getAllRegistries = _getAllRegistries as jest.Mock

jest.mock('@nxenvio/react-har-service-client', () => ({
  useGetAllNxenvArtifactsQuery: jest.fn(),
...
describe('Test Artifact List Page', () => {
  beforeAll(() => {
    ...
    useGetAllNxenvArtifactsQuery.mockImplementation(() => {
      return mockUseGetAllNxenvArtifactsQueryResponse
    })
  ...
  test('Should render proper empty list if artifacts reponse is empty', async () => {
    useGetAllNxenvArtifactsQuery.mockImplementationOnce(() => mockEmptyUseGetAllNxenvArtifactsQueryResponse)
  ...
  test('Should show error message if listing api fails', async () => {
    ...
    useGetAllNxenvArtifactsQuery.mockImplementationOnce(() => {
      return {
        ...mockErrorUseGetAllNxenvArtifactsQueryResponse,
  ...
  test('Search, Registeries, Package Types and Latest Versions filter should work', async () => {
    ...
    expect(useGetAllNxenvArtifactsQuery).toHaveBeenLastCalledWith({
      space_ref: 'undefined/+',
      queryParams: {
        page: 0,
        size: 50,
