...
export type EnumGitspaceCodeRepoType = 'github' | 'gitlab' | 'nxenv_code' | 'bitbucket' | 'unknown' | 'rapidship'
...
export type EnumInfraProviderType = 'docker' | 'nxenv_gcp' | 'nxenv_cloud' | 'hybrid_vm_gcp'
...
export interface ListGitspaceBranchesQueryParams {
  /**
   * Repository type: github, gitlab, bitbucket, nxenv_code, unknown
   */
  repo_type: string
  /**
   * Repository URL
