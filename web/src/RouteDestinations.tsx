...
import GitspaceDetails from 'cde-rapidship/pages/GitspaceDetails/GitspaceDetails'
import GitspaceListing from 'cde-rapidship/pages/GitspaceListing/GitspaceListing'
import GitspaceCreate from 'cde-rapidship/pages/GitspaceCreate/GitspaceCreate'
import ManageRepositories from 'pages/ManageSpace/ManageRepositories/ManageRepositories'

const ArApp = lazy(() => import('@ar/rapidship/ArApp'))
