 ...
 */
import vsCodeWebIcon from 'cde-rapidship/assests/vsCodeWeb.svg?url'
import vsCodeIcon from 'cde-rapidship/assests/VSCode.svg?url'
import intellijIcon from 'cde-rapidship/assests/intellij.svg?url'
import cLionIcon from 'cde-rapidship/assests/clion.svg?url'
import phpStormIcon from 'cde-rapidship/assests/phpStorm.svg?url'
import pyCharmIcon from 'cde-rapidship/assests/pyCharm.svg?url'
import rubyMineIcon from 'cde-rapidship/assests/rubyMine.svg?url'
import webStormIcon from 'cde-rapidship/assests/webStorm.svg?url'
import goLandIcon from 'cde-rapidship/assests/goLand.svg?url'
import riderIcon from 'cde-rapidship/assests/rider.svg?url'
import type { StringsMap } from 'framework/strings/stringTypes'

export const docLink = 'https://developer.nxenv.io/docs/cloud-development-environments'
