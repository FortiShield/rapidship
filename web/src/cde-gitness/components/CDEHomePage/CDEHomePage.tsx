...
import { Button, ButtonVariation, Container, Layout, Page, Text } from '@nxenvio/uicore'
import { Color, FontVariation } from '@nxenvio/design-system'
import { useHistory } from 'react-router-dom'
import gitspace from 'cde-rapidship/assests/gitspace.svg?url'
import homepageGraphics from 'cde-rapidship/assests/homepageGraphics.svg?url'
      ...
      <Container margin={{ top: 'xxxlarge' }} width="70%">
        <Layout.Horizontal margin={{ bottom: 'large' }}>
          ...
          <Button
            onClick={e => {
              e.preventDefault()
              window.open('https://developer.nxenv.io/docs/cloud-development-environments/', '_blank')
            }}
