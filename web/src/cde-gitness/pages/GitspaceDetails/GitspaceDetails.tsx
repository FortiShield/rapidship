...
import { Color, FontVariation, PopoverProps } from '@nxenvio/design-system'
import { Menu, MenuItem, PopoverInteractionKind, PopoverPosition } from '@blueprintjs/core'
import { defaultTo } from 'lodash-es'
import { useGetSpaceParam } from 'hooks/useGetSpaceParam'
import { useAppContext } from 'AppContext'
import { useStrings } from 'framework/strings'
import EventTimelineAccordion from 'cde-rapidship/components/EventTimelineAccordion/EventTimelineAccordion'
import { DetailsCard } from 'cde-rapidship/components/DetailsCard/DetailsCard'
import type { EnumGitspaceStateType, TypesGitspaceEventResponse } from 'cde-rapidship/services'
import { getIDEOption, GitspaceActionType, GitspaceStatus } from 'cde-rapidship/constants'
import { useQueryParams } from 'hooks/useQueryParams'
import { useUpdateQueryParams } from 'hooks/useUpdateQueryParams'
import { getErrorMessage } from 'utils/Utils'
import { usePolling } from 'cde-rapidship/hooks/usePolling'
import deleteIcon from 'cde-rapidship/assests/delete.svg?url'
import pauseIcon from 'cde-rapidship/assests/pause.svg?url'
import { IDEType } from 'cde-rapidship/constants'
import homeIcon from 'cde-rapidship/assests/home.svg?url'
import { useConfirmAct } from 'hooks/useConfirmAction'
import { useGitspaceDetails } from 'cde-rapidship/hooks/useGitspaceDetails'
import { useGitspaceEvents } from 'cde-rapidship/hooks/useGitspaceEvents'
import { useGitspaceActions } from 'cde-rapidship/hooks/useGitspaceActions'
import { useDeleteGitspaces } from 'cde-rapidship/hooks/useDeleteGitspaces'
import { useGitspacesLogs } from 'cde-rapidship/hooks/useGitspaceLogs'
import { useOpenVSCodeBrowserURL } from 'cde-rapidship/hooks/useOpenVSCodeBrowserURL'
import { ErrorCard } from 'cde-rapidship/components/ErrorCard/ErrorCard'
import CopyButton from 'cde-rapidship/components/CopyButton/CopyButton'
                    ...
                    <Button
                      ...
                      onClick={e => {
                        ...
                        if (data?.ide === IDEType.VSCODE) {
                          const params = standalone ? '?rapidship' : ''
                          const projectOrSpace = standalone ? space : projectIdentifier
                          const vscodeExtensionCode = standalone ? 'nxenv-inc.oss-gitspaces' : 'nxenv-inc.gitspaces'
