...
export function StringsContextProvider(props: StringsContextProviderProps): React.ReactElement {
  ...
  // useGlobalEventListener('LOAD_STRINGS_CHUNK', (e: CustomEvent<NxenvModules[]>) => {
  //   const mods = e.detail

  //   const promises = mods.map(mod => languageLoader('en', mod).then<[NxenvModules, StringsMap]>(data => [mod, data]))
