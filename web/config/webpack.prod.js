  ...
  optimization: {
    splitChunks: {
      ...
      cacheGroups: {
        ...
        designsystem: {
          test: /[\\/]node_modules[\\/](@nxenvio\/design-system)[\\/]/,
          name: 'vendor-nxenvio-design-system',
          chunks: 'all',
          priority: 5
        },

        icons: {
          test: /[\\/]node_modules[\\/](@nxenvio\/icons)[\\/]/,
          name: 'vendor-nxenvio-icons',
          chunks: 'all',
          priority: 1
        },

        uicore: {
          test: /[\\/]node_modules[\\/](@nxenvio\/uicore)[\\/]/,
          name: 'vendor-nxenvio-uicore',
          chunks: 'all',
          priority: 1
        }
      }
